<template>
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
       <el-page-header @back="goBack" content="商品信息修改">
        </el-page-header>
      </div>
...
<script>
  ...
  import {getCategory,getProUpdate,getImgUpIoad,getImgUpDelete} from '../api/user.js'
  export default {
    name: 'editoritem',
    data() {
      return {
     ...
     methods: {
         ...
         certain() {
        this.$confirm('确定修改商品？', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
            this.proUpdata.name=this.tableData.name
            this.proUpdata.desc=this.tableData.desc
            this.proUpdata.price=this.tableData.price
            this.proUpdata.categoryId=this.tableData.categoryId
            this.proUpdata.pCategoryId=this.tableData.pCategoryId
            this.proUpdata._id=this.tableData.id
            this.proUpdata.detail=this.editor.txt.html(this.valueW)
            this.proUpdata.imgs=this.urlArr  
           getProUpdate(this.proUpdata)
