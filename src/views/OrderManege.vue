  ...
  <div class="product">
    <el-card class="box-card">
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column fixed prop="orderId" label="订单号" width="300"></el-table-column>
        <el-table-column prop="recipient" label="收件人" width="300"></el-table-column>
        <el-table-column prop="status" label="订单状态" width="300"></el-table-column>
        <el-table-column prop="allPrice" label="订单总价" width="300"></el-table-column>
        <el-table-column prop="create_time" label="创建时间" width="300"></el-table-column>
        <el-table-column class="operation" fixed="right" label="操作选项" width="200">
          <template slot-scope="scope">
            <router-link :to="{name:'orderDtail',params:{data:scope.row}}">
              <el-button @click="detailClick(scope.row)" size="small">详情</el-button>
            </router-link>
          </template>
        </el-table-column>
      </el-table>
    ...
    getOrderList({ pageNum: 1, pageSize: 10 }).then(res => {
      ...
      newArr.forEach(val => {
        ...
        this.tableData.unshift({
          ...
          allPrice: val.allPrice + "元",
          status: val.status == 1 ? "未支付" : "已付款",
          id: val._id,
          orderId: val.orderId,
